...
import { setFirstLogin } from "../../../../actions/setAuthorization";
    ...
    >
      <animated.div className="welcomeModal" style={modalAnimation}>
        ...
        <h2 id="welcomeText">
          ...
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Ante in
          nibh mauris cursus mattis molestie. Amet nisl purus in mollis nunc.
        </h2>
        <button
